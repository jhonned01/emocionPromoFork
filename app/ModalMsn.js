...
const ModalMsn = () => {
  ...
  return (
    <Dialog open={Send ? true : false} onOpenChange={closeOpenModal}>
      <DialogContent className="h-auto  w-[90%] md:w-full max-h-[95vh] overflow-auto   sm:max-w-4xl">
        <DialogHeader className="w-full h-full">
          <DialogTitle>
            Estás más cerca de tener tu página web gratis{" "}
          </DialogTitle>
          <DialogDescription>
            En breve momento nos comunicaremos contigo{" "}
          </DialogDescription>
        </DialogHeader>
        <>
          <div className="grid place-items-center mx-auto p-10 sm:my-auto   rounded-t-3xl space-y-10">
